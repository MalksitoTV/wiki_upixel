---
description: >-
  Hemos adaptado las mecánicas de crianza de Pixelmon para ofrecer dos
  experiencias distintas según el mundo, aquí encontrarás toda la información
  sobre la crianza.
icon: egg
---
...
{% content-ref url="warp-abridor.md" %}
[warp-abridor.md](warp-abridor.md)
{% endcontent-ref %}
...
{% content-ref url="crianza-1.12.2-survival/" %}
[crianza-1.12.2-survival](crianza-1.12.2-survival/)
{% endcontent-ref %}
...
2. **Sistema de Guarderias**
   * Para criar, debes **dejar a los Pokémon en las maquinas disponibles**.
